  ...
  return (
    <>
      ...
      {published ? (
        <div className={s.card}>
          ...
          <div className={s.cardContent}>
            ...
            <ul className={s.cardTags}>
              {tags.map((tag, i) => (
                <li className={`${s.tag} ${tagsStyle[tag]}`} key={i}>
                  {`#${tag}`}
                </li>
              ))}
            </ul>
        ...
        <div className={`${s.card} ${!published ? `${s.notPosted}` : ""} `}>
          {!published && <div className={s.notPostedText}>Post non pubblicato</div>}
          ...
          <div className={s.cardContent}>
            ...
            <button className={`${!published ? `${s.d_none}` : `${s.cardBtn}`} `}>LEGGI DI PIÙ</button>
          </div>
        </div>
      )}
    </>
